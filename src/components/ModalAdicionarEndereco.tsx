...
interface ModalAdicionarEnderecoProps {
  rua: string;
  numero: string;
  bairro: string;
  cidade: string;
  complemento: string;
  ruaEstaVazia: boolean;
  numeroEstaVazia: boolean;
  bairroEstaVazia: boolean;
  complementoEstaVazia: boolean;
  ...
  onClick: () => void;
  onClickFecharModal: () => void;
}

export function ModalAdicionarEndereco({
  rua,
  numero,
  bairro,
  cidade,
  ...
  onClick,
  onClickFecharModal,
}: ModalAdicionarEnderecoProps) {
  return (
    <Modal isOpen={true} onRequestClose={onClickFecharModal}>
      <div>
